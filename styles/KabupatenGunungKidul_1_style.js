...
var style_KabupatenGunungKidul_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("JnRasio Je");
    var labelFont = "19.5px \'Poor Richard\', sans-serif";
    var labelFill = "#ffff32";
    var bufferColor = "";
    var bufferWidth = 0;
    var textAlign = "left";
    var offsetX = 0;
    ...
    if (value >= 94.060000 && value <= 96.132000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 96.132000 && value <= 97.140000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 97.140000 && value <= 97.838000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 97.838000 && value <= 98.618000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 98.618000 && value <= 100.360000) {
            style = [ new ol.style.Style({
