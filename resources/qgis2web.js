...
map.getView().fit([12272346.922194, -918479.546397, 12356247.482497, -868447.445391], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Rasio Jenis Kelamin Kabupaten Gunung Kidul</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (184 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini memberikan informasi terkait rasio jenis kelamin kabupaten Gunung Kidul. Sumber data dari Gunung Kidul dalam Angka, yang dipublikasikan oleh Badan Pusat Statistik Tahun 2024.<br />';
            }
